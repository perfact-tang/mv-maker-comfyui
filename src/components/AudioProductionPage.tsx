...
export const AudioProductionPage = () => {
  ...
  const generateNarratorPreview = async () => {
    ...
    try {
      ...
      const result = await generateQwen3Voice(generationProfile, profile.reference_text, true, plan.tts_language ?? profile.language);
