import { createQwen3TtsWorkflow, QWEN3_TTS_LANGUAGES } from './qwen3TtsWorkflow.ts';
...
if (result.workflow['9'].inputs.language !== 'Chinese') throw new Error('TTS language was not applied');
...
if (QWEN3_TTS_LANGUAGES.length !== 11 || !QWEN3_TTS_LANGUAGES.includes('Japanese') || !QWEN3_TTS_LANGUAGES.includes('Italian')) throw new Error('TTS language options mismatch');
